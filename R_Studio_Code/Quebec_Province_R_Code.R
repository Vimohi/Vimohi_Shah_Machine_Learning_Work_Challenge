...
require("ggplot2")
barchart = read.csv("C:\\Users\\Vimohi\\Desktop\\Work_Challenge\\Employement_By_Industry\\Data_Of_Provinces\\Quebec_Province.csv")
...
ggplot(data=dat, aes(x=Industry, y=Number_of_People_Employed, fill=Industry))+
  ...
  ggtitle("Quebec's Employement By Industries")
